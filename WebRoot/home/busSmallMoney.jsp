...
<html>
  ...
  <body>
    <div class="takeSmallMoney">
    <form id="signupForm" method="post" action="<%=basePath%>busTrading_add.action">
        <div class="m-cell">
            <div class="cell-item takeSmallMoney_canUse">
                <div class="cell-left">可用的零钱：<span id="change">${store.busChange}</span>元</div>
                <div class="cell-right"></div>
            </div>
            <div class="cell-item">
                <div class="cell-left">提现金额：</div>
                <div class="cell-right"><input type="test" name="btaMoney" class="cell-input" placeholder="0.00" id="input"
