...
<body>
	<div class="customerService" style="padding-top:53px;">
			...
			<div class="m-cell">
				...
				<div class="cell-item">
					...
					<div class="cell-right">
						<input type="text" name="mesTitle" class="cell-input"
							placeholder="" autocomplete="off" />
					</div>
				</div>
				<div class="cell-item cell-item-last">
					<div class="cell-right">
						<textarea class="cell-textarea" name="mesContent"
							placeholder="输入留言内容或直接电话联系400-800-0000"></textarea>
					</div>
				</div>
			</div>
		...
		<a href="<%=basePath%>Message_selectAll">查看我的留言</a>
	</div>
</body>
