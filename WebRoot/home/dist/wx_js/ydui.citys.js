!function () {
    var citys = [{
        ...
        "c": [{"a": ["城区", "城区以外"], "n": "密云区"}, {
            ...
            "n": "朝阳区"
        }, {"a": ["六环以内", "城区", "城区以外"], "n": "昌平区"}, {
            "a": ["城区", "城区以外"],
            "n": "平谷区"
        }, {
            "a": ["三环以内", "三环到四环之间", "四环到五环之间", "五环到六环之间", "六环以外", "西三旗", "西二旗"],
            "n": "海淀区"
        }, {"a": ["内环到二环里", "二环到三环"], "n": "西城区"}, {"a": ["内环到三环里"], "n": "东城区"}, {
            "a": ["一环到二环", "二环到三环"],
            "n": "崇文区"
        }, {"a": ["内环到三环里"], "n": "宣武区"}, {
        ...
        "n": "上海",
        "c": [{"a": ["城区"], "n": "静安区"}, {"a": ["城区"], "n": "闸北区"}, {"a": ["城区"], "n": "虹口区"}, {
            "a": ["城区"],
            "n": "杨浦区"
        }, {
            ...
            "n": "金山区"
        }, {"a": ["南桥镇", "奉城镇", "四团镇", "柘林镇", "庄行镇", "金汇镇", "青村镇", "海湾镇"], "n": "奉贤区"}, {
            "a": ["城区"],
            "n": "普陀区"
        }, {
            "a": ["城区"],
            ...
            "n": "崇明县"
        }, {"a": ["城区"], "n": "徐汇区"}, {"a": ["城区"], "n": "长宁区"}]
    }, {
        "n": "天津",
        "c": [{"a": ["全境"], "n": "东丽区"}, {"a": ["全境"], "n": "和平区"}, {"a": ["全境"], "n": "河北区"}, {
            "a": ["全境"],
            "n": "河东区"
        }, {"a": ["全境"], "n": "河西区"}, {"a": ["全境"], "n": "红桥区"}, {"a": ["全境"], "n": "蓟县"}, {
            "a": ["全境"],
            "n": "静海县"
        }, {"a": ["全境"], "n": "南开区"}, {"a": ["全境"], "n": "塘沽区"}, {
            "a": ["杨柳青,中北,精武,大寺镇,环外海泰及外环内", "其它地区"],
            "n": "西青区"
        }, {"a": ["杨村镇、下朱庄内", "其它地区"], "n": "武清区"}, {
            "a": ["双港，辛庄", "咸水沽镇、海河教育园，海河科技园", "其他地区"],
            "n": "津南区"
        }, {"a": ["汉沽区街里、汉沽开发区", "其它地区"], "n": "汉沽区"}, {
            "a": ["大港油田", "主城区内", "主城区外"],
            "n": "大港区"
        }, {"a": ["外环外双街镇，河北工大新校，屈店工业园", "外环内", "外环外其它地区"], "n": "北辰区"}, {
            "a": ["城关镇、马家店开发区、天宝工业园", "其它地区"],
            "n": "宝坻区"
        }, {"a": ["芦台镇、经济开发区、贸易开发区", "其它地区"], "n": "宁河县"}]
    }, {
        "n": "重庆",
        "c": [{
        ...
        "c": [{
            ...
            "n": "承德市"
        }, {"a": ["卢龙县", "青龙县", "昌黎县", "北戴河区", "海港区", "山海关区", "抚宁县"], "n": "秦皇岛市"}]
    }, {
        "n": "山西",
        "c": [{
            ...
            "n": "临汾市"
        }, {"a": ["盐湖区", "河津市", "永济市", "新绛县", "平陆县", "垣曲县", "绛县", "稷山县", "芮城县", "夏县", "临猗县", "万荣县", "闻喜县"], "n": "运城市"}]
    }, {
        "n": "河南",
        "c": [{
            ...
            "n": "济源市"
        }, {"a": ["魏都区", "禹州市", "长葛市", "许昌县", "鄢陵县", "襄城县"], "n": "许昌市"}, {
        ...
        "c": [{
            ...
            "n": "葫芦岛市"
        }, {"a": ["西市区", "站前区", "大石桥市", "盖州市", "老边区", "鲅鱼圈区"], "n": "营口市"}, {
            "a": ["盘山县", "大洼县", "兴隆台区", "双台子区"],
            "n": "盘锦市"
        }, {
            ...
            "n": "朝阳市"
        }, {"a": ["银州区", "清河区", "开原市", "铁岭县", "西丰县", "昌图县", "调兵山市"], "n": "铁岭市"}]
    }, {
        "n": "吉林",
        "c": [{
            ...
            "n": "通化市"
        }, {"a": ["浑江区", "临江市", "江源区", "靖宇县", "抚松县", "长白县"], "n": "白山市"}, {
        ...
        "c": [{"a": ["勃利县", "桃山区", "新兴区", "茄子河区"], "n": "七台河市"}, {
            ...
            "n": "牡丹江市"
        }, {"a": ["桦川县", "抚远县", "桦南县", "汤原县", "前进区", "向阳区", "东风区", "郊区", "同江市", "富锦市"], "n": "佳木斯市"}]
    }, {
        "n": "内蒙古",
        "c": [{
            ...
            "n": "巴彦淖尔市"
        }, {"a": ["阿拉善右旗", "阿拉善左旗", "额济纳旗"], "n": "阿拉善盟"}, {
            "a": ["乌兰浩特市", "阿尔山市", "突泉县", "扎赉特旗", "科尔沁右翼前旗", "科尔沁右翼中旗"],
            "n": "兴安盟"
        }, {"a": ["科尔沁区", "霍林郭勒市", "开鲁县", "库伦旗", "奈曼旗", "扎鲁特旗", "科尔沁左翼中旗", "科尔沁左翼后旗"], "n": "通辽市"}]
    }, {
        "n": "江苏",
        "c": [{
        ...
        "c": [{
            ...
            "n": "淄博市"
        }, {"a": ["滕州市", "山亭区", "台儿庄区", "峄城区", "薛城区", "市中区"], "n": "枣庄市"}]
    }, {
        "n": "安徽",
        "c": [{
            "a": ["铜官区", "枞阳县", "郊区", "义安区"],
            ...
            "n": "阜阳市"
        }, {"a": ["利辛县", "蒙城县", "涡阳县", "谯城区"], "n": "亳州市"}, {
            "a": ["旌德县", "宁国市", "郎溪县", "广德县", "绩溪县", "泾县", "宣州区"],
            "n": "宣城市"
        }, {"a": ["经济开发区", "埇桥区", "灵璧县", "泗县", "萧县", "砀山县"], "n": "宿州市"}, {
            "a": ["贵池区", "东至县", "石台县", "青阳县"],
            "n": "池州市"
        }, {"a": ["霍山县", "金寨县", "霍邱县", "舒城县", "金安区", "裕安区"], "n": "六安市"}]
    }, {
        "n": "浙江",
        "c": [{
        ...
        "c": [{
            ...
            "n": "龙岩市"
        }, {"a": ["蕉城区", "东侨开发区", "福安市", "福鼎市", "寿宁县", "霞浦县", "柘荣县", "屏南县", "古田县", "周宁县"], "n": "宁德市"}]
    }, {
        "n": "湖北",
        "c": [{
            ...
            "n": "咸宁市"
        }, {"a": ["恩施市", "利川市", "建始县", "来凤县", "巴东县", "鹤峰县", "宣恩县", "咸丰县"], "n": "恩施州"}, {
            "a": ["梁子湖区", "华容区", "鄂城区"],
            "n": "鄂州市"
        }, {"a": ["东宝区", "掇刀区", "钟祥市", "京山县", "沙洋县"], "n": "荆门市"}, {"a": ["曾都区", "广水市", "随县"], "n": "随州市"}]
    }, {
        "n": "湖南",
        "c": [{
            "a": ["慈利县", "桑植县", "武陵源区", "永定区"],
            ...
            "n": "岳阳市"
        }, {"a": ["汉寿县", "石门县", "安乡县", "鼎城区", "武陵区", "津市市", "澧县", "临澧县", "桃源县"], "n": "常德市"}]
    }, {
        "n": "广东",
        "c": [{
            ...
            "n": "梅州市"
        }, {"a": ["惠阳区", "大亚湾区", "惠城区", "惠东县", "博罗县", "龙门县"], "n": "惠州市"}, {
            "a": ["城区", "陆丰市", "陆河县", "海丰县"],
            "n": "汕尾市"
        }, {
        ...
        "c": [{
            ...
            "n": "桂林市"
        }, {"a": ["岑溪市", "苍梧县", "藤县", "蒙山县", "万秀区", "蝶山区", "长洲区"], "n": "梧州市"}, {
            "a": ["海城区", "银海区", "合浦县", "铁山港区"],
            "n": "北海市"
        }, {"a": ["防城区", "港口区", "东兴市", "上思县"], "n": "防城港市"}, {
            "a": ["钦南区", "钦北区", "浦北县", "灵山县"],
            "n": "钦州市"
        }, {"a": ["港南区", "港北区", "桂平市", "平南县", "覃塘区"], "n": "贵港市"}, {
            "a": ["玉州区", "北流市", "容县", "博白县", "陆川县", "兴业县"],
            "n": "玉林市"
        }, {"a": ["兴宾区", "合山市", "忻城县", "武宣县", "象州县", "金秀县"], "n": "来宾市"}]
    }, {
        "n": "江西",
        "c": [{
            "a": ["青云谱区", "西湖区", "东湖区", "昌北区", "南昌县", "进贤县", "安义县", "青山湖区", "红谷滩新区", "新建县", "湾里区", "高新区"],
            "n": "南昌市"
        }, {"a": ["珠山区", "乐平市", "浮梁县", "昌江区"], "n": "景德镇市"}, {
        ...
        "n": "四川",
        "c": [{"a": ["仁寿县", "彭山区", "洪雅县", "丹棱县", "青神县", "东坡区"], "n": "眉山市"}, {
            "a": ["雁江区", "安岳县", "乐至县", "简阳市"],
            "n": "资阳市"
        }, {
            ...
            "n": "成都市"
        }, {"a": ["自流井区", "沿滩区", "荣县", "富顺县", "大安区", "贡井区"], "n": "自贡市"}, {
            "a": ["仁和区", "西区", "东区", "米易县", "盐边县"],
            "n": "攀枝花市"
        }, {
            ...
            "n": "巴中市"
        }, {"a": ["芦山县", "石棉县", "名山区", "天全县", "荥经县", "汉源县", "宝兴县", "雨城区"], "n": "雅安市"}]
    }, {
        "n": "海南",
        "c": [{
        ...
        "c": [{
            ...
            "n": "黔东南州"
        }, {"a": ["都匀市", "福泉市", "贵定县", "惠水县", "罗甸县", "瓮安县", "荔波县", "龙里县", "平塘县", "长顺县", "独山县", "三都县"], "n": "黔南州"}]
    }, {
        "n": "云南",
        "c": [{
            "a": ["玉龙县", "华坪县", "永胜县", "宁蒗县", "古城区"],
            "n": "丽江市"
        }, {"a": ["文山市", "麻栗坡县", "砚山县", "广南县", "马关县", "富宁县", "西畴县", "丘北县"], "n": "文山州"}, {
            "a": ["香格里拉县", "德钦县", "维西县"],
            "n": "迪庆州"
        }, {
        ...
        "c": [{
            ...
            "n": "林芝地区"
        }, {"a": ["城关区", "林周县", "当雄县", "尼木县", "曲水县", "堆龙德庆县", "达孜县", "墨竹工卡县"], "n": "拉萨市"}]
    }, {
        "n": "陕西",
        "c": [{
            ...
            "n": "商洛市"
        }, {"a": ["汉滨区", "紫阳县", "岚皋县", "旬阳县", "镇坪县", "平利县", "宁陕县", "汉阴县", "石泉县", "白河县"], "n": "安康市"}]
    }, {
        "n": "甘肃",
        "c": [{
            ...
            "n": "临夏州"
        }, {"a": ["七里河区", "安宁区", "城关区", "西固区", "红古区", "永登县", "榆中县", "皋兰县"], "n": "兰州市"}, {
            "a": ["永昌县", "金川区"],
            "n": "金昌市"
        }, {
            "a": ["白银区", "平川区", "靖远县", "景泰县", "会宁县"],
            "n": "白银市"
        }, {"a": ["麦积区", "秦州区", "甘谷县", "武山县", "清水县", "秦安县", "张家川县"], "n": "天水市"}, {
            "a": ["长城区", "镜铁区", "雄关区"],
            "n": "嘉峪关市"
        }, {
            ...
            "n": "陇南市"
        }, {"a": ["凉州区", "古浪县", "天祝县", "民勤县"], "n": "武威市"}, {
            "a": ["甘州区", "山丹县", "临泽县", "高台县", "肃南县", "民乐县"],
            "n": "张掖市"
        }, {"a": ["金塔县", "阿克塞县", "肃北县", "瓜州县", "肃州区", "玉门市", "敦煌市"], "n": "酒泉市"}]
    }, {
        "n": "青海",
        "c": [{
            "a": ["湟中县", "湟源县", "大通县", "城中区", "城东区", "城西区", "城北区"],
            "n": "西宁市"
        }, {"a": ["平安县", "乐都县", "民和县", "互助县", "化隆县", "循化县"], "n": "海东地区"}, {
            "a": ["海晏县", "祁连县", "刚察县", "门源县"],
            "n": "海北州"
        }, {"a": ["尖扎县", "同仁县", "泽库县", "河南县"], "n": "黄南州"}, {
            ...
            "n": "玉树州"
        }, {"a": ["德令哈市", "乌兰县", "天峻县", "都兰县", "大柴旦行委", "冷湖行委", "茫崖行委", "格尔木市"], "n": "海西州"}]
    }, {
        "n": "宁夏",
        "c": [{"a": ["灵武市", "永宁县", "贺兰县", "兴庆区", "金凤区", "西夏区"], "n": "银川市"}, {
            "a": ["平罗县", "惠农区", "大武口区"],
            "n": "石嘴山市"
        }, {"a": ["青铜峡市", "同心县", "盐池县", "红寺堡开发区", "利通区"], "n": "吴忠市"}, {
            "a": ["西吉县", "隆德县", "泾源县", "彭阳县", "原州区"],
            "n": "固原市"
        }, {"a": ["中宁县", "海原县", "沙坡头区"], "n": "中卫市"}]
    }, {
        "n": "新疆",
        "c": [{"a": ["铁门关市"], "n": "铁门关市"}, {"a": ["五家渠市"], "n": "五家渠市"}, {"a": ["阿拉尔市"], "n": "阿拉尔市"}, {
            "a": ["图木舒克市"],
            "n": "图木舒克市"
        }, {
            "a": ["天山区", "头屯河区", "达坂城区", "米东区", "新市区", "沙依巴克区", "水磨沟区", "乌鲁木齐县"],
            "n": "乌鲁木齐市"
        }, {"a": ["克拉玛依区", "独山子区", "乌尔禾区", "白碱滩区"], "n": "克拉玛依市"}, {
            "a": ["石河子市"],
            "n": "石河子市"
        }, {"a": ["吐鲁番市", "托克逊县", "鄯善县"], "n": "吐鲁番地区"}, {
            "a": ["哈密市", "巴里坤县", "伊吾县"],
            "n": "哈密地区"
        }, {
            ...
            "n": "塔城地区"
        }, {"a": ["北屯市", "阿勒泰市", "富蕴县", "青河县", "吉木乃县", "布尔津县", "福海县", "哈巴河县"], "n": "阿勒泰地区"}]
    }, {"n": "台湾", "c": [{"a": ["台湾市区内"], "n": "台湾"}]}, {"n": "钓鱼岛", "c": [{"a": [], "n": "钓鱼岛"}]}, {
        "n": "港澳",
        "c": [{
            "a": ["中西区", "东区", "九龙城区", "观塘区", "深水埗区", "湾仔区", "黄大仙区", "油尖旺区", "离岛区", "葵青区", "北区", "西贡区", "沙田区", "屯门区", "大埔区", "荃湾区", "元朗区", "香港", "九龙", "新界"],
            "n": "香港特别行政区"
        }, {"a": ["澳门特别行政区", "澳门半岛", "凼仔", "路凼城", "路环"], "n": "澳门特别行政区"}]
    }];
