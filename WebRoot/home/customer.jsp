...
<body>
	<div class="mine">
		...
		<div class="mine_myAccount">
			<c:forEach var="cusAccount" items="${user.cusAccounts}">
				<div class="mine_mySmallMoney">
					<span>${cusAccount.cacChange}</span> <span
						class="mine_myAccount_text">零钱</span>
				</div>
				<div class="mine_myIntegral">
					<span>${cusAccount.cacPoints}</span> <span
						class="mine_myAccount_text">积分</span>
				</div>
				<div class="mine_myBonus">
					<span>${cusAccount.cacBonus}</span> <span
		...
		<div class="mine_function">
			...
			</a> <a href="#" class="mine_function_jfcz">
				<div></div> <span>积分充值</span>
			</a> <a href="#" class="mine_function_ewm">
				<div></div> <span>二维码</span>
			</a> <a href="#" class="mine_function_fx">
				<div></div> <span>分享</span>
			</a> <a href="<%=basePath%>CusAddress_selectAll.action" class="mine_function_shdz">
				<div></div> <span>收货地址</span>
			</a> <a href="<%=basePath%>home/modifyPassword.jsp" class="mine_function_xgmm">
			...
			</a> <a href="#" class="mine_function_sqrz">
				<div></div> <span>申请入驻</span>
			</a> <a href="#" class="mine_function_wddp">
				<div></div> <span>我的店铺</span>
			</a> <a href="#" class="mine_function_sjsk">
				<div></div> <span>商家收款</span>
			</a> <a href="#" class="mine_function_bdkh">
