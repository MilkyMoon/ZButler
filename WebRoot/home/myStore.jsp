	...
	<div class="myStore" style="padding-top:53px;">
		...
		<div class="myStore_content">
					...
					<c:if test="${!empty store and store.busStatus != 0}">
						<a href="<%=basePath%>busTrading_queryIncome"><img alt="" src="<%=basePath%>home/dist/wx_image/mingxi.png"><p>收款明细</p></a>
						<a href="<%=basePath%>cateLine_editBus"><img alt="" src="<%=basePath%>home/dist/wx_image/shanghu.png"><p>商户编辑</p></a>
						<a href="<%=basePath%>home/storeImg.jsp"><img alt="" src="<%=basePath%>home/dist/wx_image/tupian.png"><p>店铺图片</p></a>
						<a href="<%=basePath%>pictures_Img"><img alt="" src="<%=basePath%>home/dist/wx_image/lunbotu.png"><p>店铺轮播图</p></a>
						<a href="<%=basePath%>home/rebateProportion.jsp"><img alt="" src="<%=basePath%>home/dist/wx_image/fandian.png"><p>返点比例</p></a>
						<a href="<%=basePath%>home/PayByCash.jsp"><img alt="" src="<%=basePath%>home/dist/wx_image/xianjing.png"><p>现金支付</p></a>
						<a href="<%=basePath%>business_storeReceipts"><img alt="" src="<%=basePath%>home/dist/wx_image/shoukuan.png"><p>商家收款</p></a>
