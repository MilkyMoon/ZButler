										...
										<tbody>
											<tr>
												<c:forEach var="gro" items="${gros}">
													...
													<td>${gro.grpTitle}</td>
													<td>${gro.grpDesc}</td>
													<c:if test="${gro.grpStatus == 0}"><td>否</td></c:if>
													<c:if test="${gro.grpStatus == 1}"><td>是</td></c:if>
													<td><a href="group_read?grpId=${gro.grpId}"
														class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>&nbsp;&nbsp;查看</a>&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="group_edit?grpId=${gro.grpId}" class="btn btn-info btn-xs"><i
