...
<head>
	...
	<title>店铺分类管理 | ${sessionScope.netName.setValue}</title>
											...
											<c:forEach var="root" items="${roots}">
												<tr>
													...
													<td>
														...
														<a href="cateLine_delete?calId=${root.calId}" class="btn btn-danger btn-xs" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');"><i class="fa fa-trash-o"></i>&nbsp;&nbsp;删除</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
