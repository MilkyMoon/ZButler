				                            ...
				                            <table class="table">
				                              <tbody>
				                                <tr>
				                                  ...
				                                  <td>￥<fmt:formatNumber type="number" maxFractionDigits="10" value="${Today.divide(10000000000)}" /></td>
				                                </tr>
				                                <tr>
				                                  <th>本月收益:</th>
				                                  <td>￥<fmt:formatNumber type="number" maxFractionDigits="10" value="${Month.divide(10000000000)}" /></td>
				                                </tr>
				                                <tr>
				                                  <th>本年收益:</th>
				                                  <td>￥<fmt:formatNumber type="number" maxFractionDigits="10" value="${Year.divide(10000000000)}" /></td>
				                                </tr>
				                                <tr>
				                                  <th>累计收益:</th>
				                                  <td>￥<fmt:formatNumber type="number" maxFractionDigits="10" value="${Total.divide(10000000000)}" /></td>
				                                </tr>
				                              </tbody>
				                            </table>
				                          </div>
