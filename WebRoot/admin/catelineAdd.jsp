...
<head>
	...
	<title>店铺分类添加 | ${sessionScope.netName.setValue}</title>
...
<!-- 										<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<div class="x_content">
									<br />
									<div class="col-md-8">
										<form action="cateLine_save" class="form-horizontal form-label-left">
											<div class="">
												<div class="form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12">名&nbsp;&nbsp;&nbsp;&nbsp;称</label>
													<div class="col-md-6 col-sm-9 col-xs-12">
														<input type="text" class="form-control" name="calName" placeholder="请输入分类名称">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6 col-sm-9 col-xs-12">
														<input type="text" class="form-control" name="calAuth" placeholder="请输入权重值（数值越大权重越高）">
													</div>
												</div>
