...
<title>代理商账单申请管理 | ${sessionScope.netName.setValue}</title>
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<form action="thuTrading_select" method="get">
							<div class="title_right">
								<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
									<div class="input-group">
										<input type="text" class="form-control" name="keywords" placeholder="输入地区、姓名 ...">
...
<!-- 										<li class="dropdown"><a href="#" class="dropdown-toggle"
				                      ...
				                      <tbody>
				                      	<c:forEach var="list" items="${list}">
											<tr class="even pointer">
												...
												<td>${list.thtTime}</td>
												<td>
													<c:if test="${list.thtStatus == 0}">
														<a href="thuTrading_status?thtId=${list.thtId}&thtStatus=1" class="btn btn-primary btn-xs" style="background-color:#3bce83;border-color: #28b90e;">
															<i class="fa fa-folder"></i>&nbsp;&nbsp;允许
														</a>&nbsp;&nbsp;&nbsp;&nbsp;
														
														<a href="thuTrading_status?thtId=${list.thtId}&thtStatus=2" class="btn btn-primary btn-xs">
															<i class="fa fa-folder"></i>&nbsp;&nbsp;不允许
														</a>&nbsp;&nbsp;&nbsp;&nbsp;
													</c:if>
													<c:if test="${list.thtStatus == 1}">
														<a class="btn btn-primary btn-xs">
															<i class="fa fa-folder"></i>&nbsp;&nbsp;已允许
														</a>&nbsp;&nbsp;&nbsp;&nbsp;
													</c:if>
													<c:if test="${list.thtStatus == 2}">
														<a class="btn btn-primary btn-xs">
															<i class="fa fa-folder"></i>&nbsp;&nbsp;已不允许
														</a>&nbsp;&nbsp;&nbsp;&nbsp;
													</c:if>
					...
					<%-- <div class="row">
						<form action="thuTrading_selectAll">
							<div class="col-sm-5">
									...
									<ul class="pagination">
										<c:if test="${page.hasPrePage}">
											<li class="paginate_button previous" id="datatable-checkbox_previous">
												<a href="thuTrading_selectAll?pageNow=${page.currentPage-1}&everyPage=${page.everyPage}" data-dt-idx="0" tabindex="0">上一页</a>
											</li>
											<li class="paginate_button">
												<a href="thuTrading_selectAll?pageNow=1&everyPage=${page.everyPage}" data-dt-idx="1" tabindex="0">首页</a>
											</li>
										</c:if>
										<c:if test="${!page.hasPrePage}">
										...
										<c:if test="${page.hasNextPage}">
											<li class="paginate_button">
												<a href="thuTrading_selectAll?pageNow=${page.totalPage}&everyPage=${page.everyPage}" data-dt-idx="3" tabindex="0">尾页</a>
											</li>
											<li class="paginate_button next" id="datatable-checkbox_next">
												<a href="thuTrading_selectAll?pageNow=${page.currentPage+1}&everyPage=${page.everyPage}" data-dt-idx="4" tabindex="0">下一页</a>
											</li>
										</c:if>
										<c:if test="${!page.hasNextPage}">
											<li class="paginate_button active">
