...
public class WxOauthRedirectActioin extends ActionSupport implements ServletRequestAware, ServletResponseAware {
	...
	public void oauth() throws WxErrorException {
		...
		config.setSecret("029b4c9b947564b763b0191445aabdca"); // 设置微信公众号的 appsecret
