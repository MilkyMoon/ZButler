...
public class ReturnSelectHql {
	public static String ReturnHql(Class c, Object t) throws NoSuchMethodException, SecurityException,
		...
		String hql = "from " + c.getSimpleName() + " where ";
				...
				if (m.invoke(t) != null && !"".equals(m.invoke(t))) {
					...
					case "Integer":
						if (flag) {
							...
							hql += " and " + fs[i].getName() + "=" + m.invoke(t);
						}
						break;
					case "Float":
						if (flag) {
					...
					case "String":
						if (flag) {
							...
							hql += " and " + fs[i].getName() + "='" + (String) m.invoke(t) + "'";
						}
						break;
					case "Date":
					...
					default:
						...
						if (flag) {
							...
							hql += " and " + fs[i].getName() + "." + idStringOther + "=" + mOther.invoke(m.invoke(t)) + "";
						}
					}
				}
			}
